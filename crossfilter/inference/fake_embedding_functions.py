...
def compute_image_embeddings(
    ...
    Args:
        ...
        batch_size: Number of images to process in each batch (kept for API compatibility)
    ...
    for i in range(0, len(image_paths), batch_size):
        ...
        for image_path in batch_paths:
            ...
            try:
                ...
                # Center crop to square to match SIGLIP2 preprocessing
                ...
                embedding = np.array([r_mean, g_mean, b_mean, r_std, g_std, b_std], dtype=np.float32)
...
def compute_text_embeddings(
    ...
    Args:
        ...
        batch_size: Number of captions to process in each batch (kept for API compatibility)
        model_name: Model name (kept for API compatibility)
    ...
    for i in range(0, len(captions), batch_size):
        ...
        for caption in batch_captions:
            ...
            consonant_count = sum(1 for c in caption.lower() if c.isalpha() and c not in 'aeiou')
    ...
    for i in range(0, len(image_embeddings), batch_size):
        ...
        for embedding in batch_embeddings:
            ...
            if r_mean > g_mean and r_mean > b_mean:
                ...
                if g_std > 0.3:
                    captions.append("An image with varied green tones and natural elements")
                else:
                ...
                if overall_std > 0.25:
                    captions.append("A colorful image with balanced tones and high contrast")
                else:
