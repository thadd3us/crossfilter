...
# THAD: Lots of tests in this file don't have type annotations on parameters, please fix.
def test_add_quantized_columns_spatial(
...
def test_add_quantized_columns_temporal(
    sample_df: pd.DataFrame, snapshot: SnapshotAssertion
) -> None:
...
def test_aggregate_by_h3(sample_df) -> None:
    ...
    expected_cols = [get_h3_column_name(h3_level), "lat", "count", "lon", "df_ids"]
