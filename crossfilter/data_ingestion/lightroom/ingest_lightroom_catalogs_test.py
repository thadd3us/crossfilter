...
from crossfilter.data_ingestion.ingest_lightroom_catalogs import (
...
def create_test_zip_with_catalog(zip_path: Path, catalog_name: str = "test.lrcat") -> None:
...
def test_load_lightroom_catalog_real_data(test_catalogs_dir: Path) -> None:
    ...
    test_catalog = test_catalogs_dir / "test_catalog_01" / "test_catalog_gps_captions_collections_keywords.lrcat"
...
def test_large_ignore_collections_set() -> None:
    ...
    config = LightroomParserConfig(
        ignore_collections=large_ignore_set,
