    ...
    if df.empty:
        return {
            ...
            "config": {
                ...
                "mapState": {"latitude": 37.7749, "longitude": -122.4194, "zoom": 10},
            },
        }
    ...
    if has_count_col:
        ...
        layer_config = {
            ...
            "config": {
                ...
                "label": "Data Points",
                "color": [23, 184, 190],
                "columns": {"lat": "GPS_LATITUDE", "lng": "GPS_LONGITUDE"},
                "isVisible": True,
                "visConfig": {
                    "opacity": 0.8,
                    "strokeOpacity": 0.8,
                ...
                "interactionConfig": {
                    "tooltip": {
                        ...
                        "fieldsToShow": {
                            "crossfilter_data": [
                                (
                                    {"name": "UUID_LONG", "format": None}
                                    if not has_count_col
                                    else {"name": "count", "format": None}
                                )
                            ]
                        },
                    },
...
def create_fallback_scatter_geo(
    df: pd.DataFrame, title: str = "Geographic Distribution"
) -> dict[str, Any]:
    """
    ...
    fig.update_layout(height=500, margin={"l": 0, "r": 0, "t": 50, "b": 0})
